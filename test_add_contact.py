...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        self.create_contact(wd, firstname="Vasyly", lastname="Petrov", nickname="vasya26", company="Google",
    ...
    def create_contact(self, wd, firstname, lastname, nickname, company, address, mobile_phone, email):
        # filling firstname
